...
impl Element {
    ...
    pub fn period(&self) -> u32 {
        match self {
            ...
            Element::Zirconium => 5,
            Element::Niobium => 5,
            Element::Molybdenum => 5,
            Element::Technetium => 5,
            Element::Ruthenium => 5,
            Element::Rhodium => 5,
            Element::Palladium => 5,
            Element::Silver => 5,
            ...
            Element::Lanthanum => 6,
            Element::Cerium => 6,
            Element::Praseodymium => 6,
            Element::Neodymium => 6,
            Element::Promethium => 6,
            Element::Samarium => 6,
            Element::Europium => 6,
            Element::Gadolinium => 6,
            Element::Terbium => 6,
            Element::Dysprosium => 6,
            Element::Holmium => 6,
            Element::Erbium => 6,
            Element::Thulium => 6,
            Element::Ytterbium => 6,
            ...
            Element::Curium => 7,
            Element::Berkelium => 7,
            Element::Californium => 7,
            Element::Einsteinium => 7,
            Element::Fermium => 7,
            Element::Mendelevium => 7,
            Element::Nobelium => 7,
            Element::Lawrencium => 7,
            Element::Rutherfordium => 7,
            Element::Dubnium => 7,
            Element::Seaborgium => 7,
            Element::Bohrium => 7,
            Element::Hassium => 7,
            Element::Meitnerium => 7,
            Element::Darmstadtium => 7,
            Element::Roentgenium => 7,
            Element::Copernicium => 7,
            Element::Nihonium => 7,
            Element::Flerovium => 7,
            Element::Moscovium => 7,
            Element::Livermorium => 7,
            Element::Tennessine => 7,
            Element::Oganesson => 7,
        }
    }
    ...
    pub fn block(&self) -> &str {
        match self {
            ...
            Element::Zirconium => "d",
            Element::Niobium => "d",
            Element::Molybdenum => "d",
            Element::Technetium => "d",
            Element::Ruthenium => "d",
            Element::Rhodium => "d",
            Element::Palladium => "d",
            Element::Silver => "d",
            ...
            Element::Lanthanum => "f",
            Element::Cerium => "f",
            Element::Praseodymium => "f",
            Element::Neodymium => "f",
            Element::Promethium => "f",
            Element::Samarium => "f",
            Element::Europium => "f",
            Element::Gadolinium => "f",
            Element::Terbium => "f",
            Element::Dysprosium => "f",
            Element::Holmium => "f",
            Element::Erbium => "f",
            Element::Thulium => "f",
            Element::Ytterbium => "f",
            ...
            Element::Curium => "f",
            Element::Berkelium => "f",
            Element::Californium => "f",
            Element::Einsteinium => "f",
            Element::Fermium => "f",
            Element::Mendelevium => "f",
            Element::Nobelium => "f",
            Element::Lawrencium => "d",
            Element::Rutherfordium => "d",
            Element::Dubnium => "d",
            Element::Seaborgium => "d",
            Element::Bohrium => "d",
            Element::Hassium => "d",
            Element::Meitnerium => "d",
            Element::Darmstadtium => "d",
            Element::Roentgenium => "d",
            Element::Copernicium => "d",
            Element::Nihonium => "p",
            Element::Flerovium => "p",
            Element::Moscovium => "p",
            Element::Livermorium => "p",
            Element::Tennessine => "p",
            Element::Oganesson => "p",
        }
    }
